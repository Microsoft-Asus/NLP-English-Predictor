      ...
      tabPanel("predictor",
        ...
        fluidPage(
          ...
          column(8, align="left", offset = 2, style = "padding:1.5em;",
                 h1("word predictor", style='color: #e6e6e6'),
                 br(), br()),
        ...
        fluidPage(
          ...
          div(id = "english",
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("The app takes text as input and automatically 
             ...
             column(10, align="justify", offset = 1,
                    ...
                    tags$ol(
                      ...
                      tags$li("A partial English Wikipedia dump containing updated 
                              articles. Downloaded on Aug 18, 2017 ", 
                              style="color: white"), 
                      tags$li("A collection of recent, popular, and trending 
                              topics Twitter posts from Aug 28-30, 2017 ",
                              style="color: white"), 
                      tags$li("The entire May 9, 2017 Memory Alpha Encyclopedia 
                              dump. Downloaded on Aug 28, 2017", 
                              style="color: white")
                      ),
                    ...
                    p("A goal during preprocessing was to keep it minimal in 
                      ...
                      possible about how English is typed, including grammar, 
                      common misspellings, contractions, abbreviations, 
                      acronyms, and slang.", 
                      style="color: white"), 
                    p("The final corpus used for the predictor contains ~165.5 
                      million words in a ~1 GiB uncompressed file.", 
                      style="color: white"),
          ...
          hidden(div(id = "espanol",
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("La aplicación admite texto en inglés y automáticamente 
                      provee:", style="color: white"), 
                    tags$ol(
             ...
             column(10, align="justify", offset = 1,
                    ...
                    p("El procesamiento se mantuvo intencionalmente al mínimo  
                      para así capturar el inglés tal y como es comúnmente  
                      escrito, incluyendo gramática,  errores ortográficos,  
                      abreviaciones, siglas, y jerga.", 
                      style="color: white"),
                    p("El corpus procesado contiene ~165.5 millones de palabras 
                      en un archivo de ~1 GiB.", 
                      style="color: white"),
